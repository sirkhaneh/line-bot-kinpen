...
async function analyzeFoodText(foodText: string): Promise<string> {
  ...
  "2. ถ้าเมนูนี้มีสารอาหารที่เกี่ยวข้องกับสุขภาพระบบสืบพันธุ์เพศชายและคุณภาพอสุจิ (เช่น zinc, selenium, omega-3, antioxidant, vitamin C, vitamin E, folate, CoQ10) ให้ชี้ให้เห็นว่าเมนูนี้ช่วยหรือไม่ช่วยตรงนี้ยังไง แบบสั้นๆ เป็นกันเอง\n" +
  "3. แนะนำมื้อต่อไปสั้นๆ ว่าควรเพิ่มอะไร\n\n" +
  "ถ้าผู้ใช้พิมพ์เรื่องอื่นที่ไม่เกี่ยวกับอาหาร (ทักทาย ถามเรื่องทั่วไป พูดคุยเล่น) ให้ตอบแบบเพื่อนคุยเป็นกันเองสั้นๆ ตามคาแรกเตอร์ 'กินเป็น' แล้วชวนกลับมาที่เรื่องอาหารเบาๆ เช่น ถามว่ามื้อนี้กินอะไรไปแล้วบ้าง อย่าพยายามยัดเรื่องที่ไม่ใช่อาหารเข้ากรอบวิเคราะห์โภชนาการ\n\n" +
